(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/node_modules_@clerk_backend_dist_c4c3da3d._.js",
...
;
;
var errorThrower = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$error$2d$B2RA62bv$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["buildErrorThrower"])({
    packageName: "@clerk/backend"
});
var { isDevOrStagingUrl } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$keys$2d$Dcilj3cS$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["createDevOrStagingUrlCache"])();
;
...
"[project]/node_modules/@clerk/backend/dist/chunk-6L5YGIE4.mjs [middleware-edge] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var createRedirect = (params)=>{
    ...
    const parsedPublishableKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$keys$2d$Dcilj3cS$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["parsePublishableKey"])(publishableKey);
...
function assertValidPublishableKey(val) {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$keys$2d$Dcilj3cS$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["parsePublishableKey"])(val, {
        fatal: true
    });
}
;
...
var AuthenticateContext = class {
   ...
   */ isKnownClerkReferrer() {
    ...
    initPublishableKeyValues(options) {
        ...
        const originalPk = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$keys$2d$Dcilj3cS$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["parsePublishableKey"])(this.publishableKey, {
            fatal: true,
            domain: options.domain,
            isSatellite: options.isSatellite
        });
        this.originalFrontendApi = originalPk.frontendApi;
        const pk = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$keys$2d$Dcilj3cS$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["parsePublishableKey"])(this.publishableKey, {
            fatal: true,
    ...
    getSuffixedCookie(name) {
        return this.getCookie((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$keys$2d$Dcilj3cS$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getSuffixedCookieName"])(name, this.cookieSuffix)) || void 0;
    }
...
var UserAPI = class extends AbstractAPI {
    ...
    async getUserOauthAccessToken(userId, provider) {
        ...
        if (hasPrefix) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$deprecated$2d$CFM4jPRM$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["deprecated"])("getUserOauthAccessToken(userId, provider)", "Remove the `oauth_` prefix from the `provider` argument.");
        }
        return this.request({
            method: "GET",
...
function parseErrors(data) {
    if (!!data && typeof data === "object" && "errors" in data) {
        ...
        return errors.length > 0 ? errors.map(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$error$2d$B2RA62bv$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["parseError"]) : [];
    }
    return [];
}
function withLegacyRequestReturn(cb) {
    return async (...args)=>{
        ...
        if (errors) {
            const error = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$error$2d$B2RA62bv$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["ClerkAPIResponseError"](statusText || "", {
                data: [],
                status,
                clerkTraceId,
                retryAfter
...
function signedInAuthObject(authenticateContext, sessionToken, sessionClaims) {
    ...
    return {
        ...
        getToken,
        has: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$authorization$2d$XX4mKaAz$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["createCheckAuthorization"])({
            orgId,
            orgRole,
            orgPermissions,
            userId,
...
function handleClerkAPIError(tokenType, err, notFoundMessage) {
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$error$2d$B2RA62bv$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["isClerkAPIResponseError"])(err)) {
        let code;
        let message;
        switch(err.status){
            case 401:
...
var OrganizationMatcher = class {
    ...
    createMatcher(pattern) {
        ...
        try {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$pathToRegexp$2d$cujoshIK$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["match"])(pattern);
        } catch (e) {
...
function assertSignInUrlExists(signInUrl, key) {
    if (!signInUrl && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$keys$2d$Dcilj3cS$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["isDevelopmentFromSecretKey"])(key)) {
...
function encodeJwtData(value) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AR5UB427$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["base64url"].stringify(encoded, {
        pad: false
    });
}
async function signJwt(payload, key, options) {
    ...
    const encoder = new TextEncoder();
    const algorithm = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AR5UB427$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["getCryptoAlgorithm"])(options.algorithm);
    if (!algorithm) {
        return {
            errors: [
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$HNJNM32R$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["SignJWTError"](`Unsupported algorithm ${options.algorithm}`)
            ]
        };
    }
    const cryptoKey = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AR5UB427$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["importKey"])(key, algorithm, "sign");
    ...
    try {
        const signature = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AR5UB427$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["runtime"].crypto.subtle.sign(algorithm, cryptoKey, encoder.encode(firstPart));
        const encodedSignature = `${firstPart}.${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$AR5UB427$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["base64url"].stringify(new Uint8Array(signature), {
            pad: false
        })}`;
        return {
        ...
        return {
            errors: [
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$HNJNM32R$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["SignJWTError"](error?.message)
            ]
        };
    }
}
...
;
;
var verifyToken2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$P263NW7Z$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["withLegacyReturn"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$6L5YGIE4$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["verifyToken"]);
function createClerkClient(options) {
    const opts = {
        ...options
    };
    const apiClient = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$6L5YGIE4$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createBackendApiClient"])(opts);
    const requestState = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$backend$2f$dist$2f$chunk$2d$6L5YGIE4$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createAuthenticateRequest"])({
        options: opts,
        apiClient
    });
    const telemetry = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$runtime$2f$telemetry$2d$x9LpQpc1$2e$mjs__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["TelemetryCollector"]({
...
//# sourceMappingURL=node_modules_%40clerk_backend_dist_c4c3da3d._.js.map