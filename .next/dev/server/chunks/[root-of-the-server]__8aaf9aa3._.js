...
// Helper function to load pdfjs dynamically with Node.js polyfills
async function loadPdfJs() {
    // Import canvas for Node.js polyfills
    const canvas = await __turbopack_context__.A("[externals]/canvas [external] (canvas, cjs, async loader)");
    // Polyfill DOMMatrix and other canvas APIs for Node.js
    ...
    // Disable worker for Node.js (workers don't work well in server environment)
 ...
 */ async function extractTextFromPdf(arrayBuffer) {
    ...
    for(let i = 1; i <= numPages; i++){
        ...
        // Add page separator
        fullText += pageText + '\n\n';
        console.log(`Extracted text from page ${i}/${numPages}`);
    }
...
async function POST(request) {
    try {
        ...
        try {
            ...
            pdfData = await extractTextFromPdf(arrayBuffer);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8aaf9aa3._.js.map